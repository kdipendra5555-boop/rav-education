...
import OrbisPage from "./pages/OrbisPage.jsx";
import CertificateCardsPage from "./component/Orbis/CertificateCardsPage.jsx";
import RedHome from "./component/Initiative/redbyte/redHome.jsx";
import RedForm from "./component/Initiative/redbyte/RedForm.jsx";
import RedCourses from "./component/Initiative/redbyte/RedCourses.jsx";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/initiatives/redByte" element={<RedHome/>}/>
        <Route path="/redbyte/student/join/wings" element={<RedForm/>}/>
        <Route path="/redbyte/courses" element={<RedCourses/>}/>


        {/* Certificate */}
        <Route path="/orbis-89723d89sdf8878sdfjfb" element={<OrbisPage/>}/>
        <Route path="/certifications" element={<CertificateCardsPage/>}/>
